...
public class Boid3DComponent extends BaseEntityComponent {
    ...
    private var _edgeBehavior:uint;
     ...
     */
    public function get edgeBehavior():uint {
        return _edgeBehavior;
    }

    public function set edgeBehavior(value:uint):void {
    ...
    //___________________________________________________________
    //——————————————————————————————————————————————— CONSTRUCTOR
    public function Boid3DComponent(parameters:Object = null) {
        super(parameters);
        reset();
    }
    ...
    public function getTransformMatrix():Matrix3D {
        _matrix.identity();
        _matrix.appendTranslation(_position.x, _position.y, _position.z);
        return _matrix;
    }
     ...
     *
     */
    public function constrainToRect(rect:Rectangle, behavior:uint = EDGE_BOUNCE, zMin:Number = NaN, zMax:Number = NaN):void {
        if (!_renderData || !_renderData.stage || !_renderData.visible) {
            return;
        }
        calculateScreenCoords();
     ...
     * below 1.0
     */
    public function flock(boids:Vector.<Boid3DComponent>, separationWeight:Number = 0.5, alignmentWeight:Number = 0.1, cohesionWeight:Number = 0.2, separationDistance:Number = 100.0, alignmentDistance:Number = 200.0, cohesionDistance:Number = 200.0):void {
     ...
     * below 1.0
     */
    public function separate(boids:Vector.<Boid3DComponent>, separationDistance:Number = 50.0, multiplier:Number = 1.0):void {
     ...
     * below 1.0
     */
    public function align(boids:Vector.<Boid3DComponent>, neighborDistance:Number = 40.0, multiplier:Number = 1.0):void {
     ...
     * below 1.0
     */
    public function cohesion(boids:Vector.<Boid3DComponent>, neighborDistance:Number = 10.0, multiplier:Number = 1.0):void {
    ...
    private function getSeparation(boids:Vector.<Boid3DComponent>, separation:Number = 25.0):Vector3D {
        var force:Vector3D = new Vector3D();
        var difference:Vector3D;
        var distance:Number;
        var count:int = 0;
        var boid:Boid3DComponent;
    ...
    private function getAlignment(boids:Vector.<Boid3DComponent>, neighborDistance:Number = 50.0):Vector3D {
        var force:Vector3D = new Vector3D();
        var distance:Number;
        var count:int = 0;
        var boid:Boid3DComponent;
    ...
    private function getCohesion(boids:Vector.<Boid3DComponent>, neighborDistance:Number = 50.0):Vector3D {
        var force:Vector3D = new Vector3D();
        var distance:Number;
        var count:int = 0;
        var boid:Boid3DComponent;
