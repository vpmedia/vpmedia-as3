...
public class DistortImage {
     ...
     * @private
     */
    protected function draw(graphics:Graphics, bmd:BitmapData):void {
        var t:Number;
        var vertices:Array;
     ...
     *
     * @see    hu.vpmedia.display.DistortImage#width
     * @see    hu.vpmedia.display.DistortImage#height
     *
     */
     ...
     *
     * @see    hu.vpmedia.display.DistortImage#hPrecision
     * @see    hu.vpmedia.display.DistortImage#vPrecision
     *
     */
     ...
     * @see    hu.vpmedia.display.DistortImage#setSize()
     */
     ...
     * @see    hu.vpmedia.display.DistortImage#setPrecision()
     */
