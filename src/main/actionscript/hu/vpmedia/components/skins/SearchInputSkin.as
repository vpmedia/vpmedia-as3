 ...
 * @inheritDoc
 */
public class SearchInputSkin extends BaseSkin {
     ...
     * Constructor
     */
    public function SearchInputSkin(config:BaseSkinConfig = null) {
        super(config);
    }
    ...
    override protected function createChildren():void {
        background = new Rect();
        addChild(background);
        label = new Label(this, {styleGroup: owner.toString()});
    }
    ...
    override public function draw():void {
        ...
        var labelStyle:TextFieldConfig = TextFieldConfig(owner.getStyle(_config.labelStyleID));
        label.setSize(owner.width, owner.height);
        label.text = IBaseTextField(owner).text;
    }
}
}
