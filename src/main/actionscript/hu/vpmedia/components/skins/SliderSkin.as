 ...
 * @inheritDoc
 */
public class SliderSkin extends BaseSkin {
     ...
     * Constructor
     */
    public function SliderSkin(config:BaseSkinConfig = null) {
        super(config);
    }
    ...
    override protected function createChildren():void {
        ...
        button = new Button(this, {width: _owner.width, height: _owner.width, showIcon: true, showLabel: false, styleGroup: _owner.toString()});
        button.name = "button";
    }
